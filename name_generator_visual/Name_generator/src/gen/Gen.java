...
//					hour_salary = Integer.parseInt(txtHour.getText());
//					num_hour = spinnerHours.getSelection();
//					num_years = spinnerYears.getSelection();
//					total = (hour_salary*num_hour)*52 * num_years;
//					lblAnswer.setText(String.valueOf(total));
//				}
				if (btnAnnual.getEnabled()) {
					annual_salary = Integer.parseInt(txtAnnual.getText());
					num_years = spinnerYears.getSelection();
					total = annual_salary*num_years;
					lblAnswer.setText(String.valueOf(total));
				}
			}
		});
